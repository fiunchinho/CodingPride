...
class CoreContributorConditionTest extends \PHPUnit_Framework_TestCase
{
	public function testConditionIsMetWhenRightPath()
	{
		$file = $this->getMock( '\CodingPride\Document\File', array( 'getPath' ) );
		$file->expects( $this->once() )->method( 'getPath' )->will( $this->returnValue( '/backend/engine/public/index.php' ) );
		...
		$condition = new \CodingPride\Condition\CoreContributorCondition();
