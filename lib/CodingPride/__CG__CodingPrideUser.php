...
namespace Proxies\__CG__\CodingPride;
 ...
 */
class User extends \CodingPride\User implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getUserBadgesToAchieve($badges);
    }

    public function addBadge(\CodingPride\Badge $badge)
    {
        $this->__load();
        return parent::addBadge($badge);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'username', 'badges');
    }
